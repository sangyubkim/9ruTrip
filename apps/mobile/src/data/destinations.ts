...
export const CITIES: Record<string, DestinationCity> = {
  ...
  pyeongchang: city("pyeongchang", "평창", "Pyeongchang", "kr", "KRW", 37.3705, 128.3902, "Asia/Seoul", "domestic", "naver"),
  hongcheon: city("hongcheon", "홍천", "Hongcheon", "kr", "KRW", 37.6970, 127.8887, "Asia/Seoul", "domestic", "naver"),
  yangyang: city("yangyang", "양양", "Yangyang", "kr", "KRW", 38.0754, 128.6191, "Asia/Seoul", "domestic", "naver"),
  inje: city("inje", "인제", "Inje", "kr", "KRW", 38.0697, 128.1704, "Asia/Seoul", "domestic", "naver"),
  jeongseon: city("jeongseon", "정선", "Jeongseon", "kr", "KRW", 37.3800, 128.6609, "Asia/Seoul", "domestic", "naver"),
  // 충청북도
  ...
  jangheung: city("jangheung", "장흥", "Jangheung", "kr", "KRW", 34.6816, 126.9069, "Asia/Seoul", "domestic", "naver"),
  boseong: city("boseong", "보성", "Boseong", "kr", "KRW", 34.7713, 127.0801, "Asia/Seoul", "domestic", "naver"),
  damyang: city("damyang", "담양", "Damyang", "kr", "KRW", 35.3212, 126.9882, "Asia/Seoul", "domestic", "naver"),
  haenam: city("haenam", "해남", "Haenam", "kr", "KRW", 34.5733, 126.5992, "Asia/Seoul", "domestic", "naver"),
  // 경상북도
  ...
  bonghwa: city("bonghwa", "봉화", "Bonghwa", "kr", "KRW", 36.8931, 128.7320, "Asia/Seoul", "domestic", "naver"),
  cheongdo: city("cheongdo", "청도", "Cheongdo", "kr", "KRW", 35.6474, 128.7339, "Asia/Seoul", "domestic", "naver"),
  yeongdeok: city("yeongdeok", "영덕", "Yeongdeok", "kr", "KRW", 36.4150, 129.3652, "Asia/Seoul", "domestic", "naver"),
  uljin: city("uljin", "울진", "Uljin", "kr", "KRW", 36.9931, 129.4004, "Asia/Seoul", "domestic", "naver"),
  // 경상남도
  ...
  changnyeong: city("changnyeong", "창녕", "Changnyeong", "kr", "KRW", 35.5446, 128.4921, "Asia/Seoul", "domestic", "naver"),
  hadong: city("hadong", "하동", "Hadong", "kr", "KRW", 35.0671, 127.7517, "Asia/Seoul", "domestic", "naver"),
  sancheong: city("sancheong", "산청", "Sancheong", "kr", "KRW", 35.4156, 127.8735, "Asia/Seoul", "domestic", "naver"),
  geochang: city("geochang", "거창", "Geochang", "kr", "KRW", 35.6867, 127.9095, "Asia/Seoul", "domestic", "naver"),
  namhae: city("namhae", "남해", "Namhae", "kr", "KRW", 34.8377, 127.8925, "Asia/Seoul", "domestic", "naver"),
...
export const COUNTRIES: CountryMeta[] = [
  country("kr", "한국", "Korea", "🇰🇷", [
    ...
    "chuncheon", "gangneung", "donghae", "samcheok", "sokcho", "wonju", "taebaek", "pyeongchang", "hongcheon", "yangyang", "inje", "jeongseon",
    ...
    "yeosu", "suncheon", "mokpo", "gwangyang", "naju", "jangheung", "boseong", "damyang", "haenam",
    "gyeongju", "gimcheon", "andong", "gumi", "yeongju", "yeongcheon", "sangju", "mungyeong", "gyeongsan", "pohang", "bonghwa", "cheongdo", "yeongdeok", "uljin",
    "changwon", "tongyeong", "geoje", "gimhae", "miryang", "sacheon", "yangsan", "jinju", "changnyeong", "hadong", "sancheong", "geochang", "namhae",
    "jeju", "seogwipo",
  ]),
